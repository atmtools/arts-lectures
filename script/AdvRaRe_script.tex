...
\subsection*{Script author contributions}
...
draft of Section \ref{sec:energy-states}.
...
In case of a diatomic molecule, we can use the \textbf{reduced mass
...
%\colorbox{red}{FIXME: What are the names of $k$ and $\mu$?}\\  FIXED!
...
\begin{equation}
\alpha=n \cdot \sigma \rightarrow \frac{\partial \alpha}{\partial n}=\sigma,
\end{equation}
