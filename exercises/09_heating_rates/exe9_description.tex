...
the upward and downward longwave radiation fluxes. Here, we will consider only the longwave flux.
Calculate the net flux and plot upward, downward and net flux together in one figure against altitude.
Explain the plot.
\item Implement the function \texttt{calc\_heatingrates(...)}. Use the function to calculate 
the heating rate. Plot the heating rate against altitude and explain the plot. 
How would a heating rate in thermal equilibrium assuming only longwave radiation look like?
