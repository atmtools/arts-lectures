...
$ cp ../01-rotational_spectra/absorption.py line_shape.py
\end{lstlisting}
\medskip{}
The ``calculate\_absxsec'' function within your python script calculates
absorption cross sections and uses several keyword arguments as inputs,
among other lineshape and forefactor. Please use ``Voigt\_Kuntz6''
as line shape and ``VVH'' as fore factor:\\
