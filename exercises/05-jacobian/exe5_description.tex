...
\begin{enumerate}
\item Run the Python script jacobian.py to calculate the brightness temperature
...
brightness temperature spectrum of task 1 and rerun the Python script
jacobian.py. This will calculate the water vapor Jacobian and the
